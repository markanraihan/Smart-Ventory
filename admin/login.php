...
<head>
    ...
    <title>Admin Login | SmartVentory</title>
...
<body>
    <div class="container">
        <div class="login-container">
            <div class="login-header">
                <h2>SmartVentory</h2>
                <p>Welcome back, please login admin account</p>
            </div>
    ...
    <script>
        ...
        document.querySelector('.form-floating:last-child').style.position = 'relative';
        document.querySelector('.form-floating:last-child').appendChild(togglePassword);
