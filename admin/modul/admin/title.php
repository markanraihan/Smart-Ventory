...
<head>
  ...
  <!-- tema css -->
  <link href="../css/awalAdmin.css" rel="stylesheet">
          ...
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="?m=barangMasuk&s=awal">
                <i class="fa fa-cart-plus"></i> Data Jumlah Barang Masuk
              </a>
            </li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <p class="text-muted" style="font-size: 16px;">Copyright &copy;
              <script>document.write(new Date().getFullYear());</script> Muhamad Zibran Fitadiyatama All rights reserved
            </p>
          </div>
        </div>
      </div>
